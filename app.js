...
const UNIT_OPTIONS = ["CF09", "BC-07", "BC-09", "BC-11", "BC-14", "BC-15", "E-01", "E-02", "L-02", "E-03", "R-03", "E-04", "T-04", "E-05", "E-06", "R-06", "E-07", "TW-07", "E-08", "R-08", "E-09", "TW-09", "E-10", "E-11", "E-12", "T-12", "E-13", "L-13", "R-13", "L-14", "L-15", "L-16", "TW-17", "E-18", "E-19", "E-20", "E-21", "SF-1", "SF-2", "SF-3", "SF-4", "SF-5", "SF-6"];
...
function TacticalWorksheet() {
  ...
  function updateLifeFlightUnit(listKey, id, field, value) {
    setState(s => {
      const list = s.lifeFlight[listKey].map(u => u.id === id ? {
        ...u,
        [field]: value
      } : u);
      const draft = {
  ...
  const assignedEmsUnits = [...state.firstAlarmEmsUnits, ...state.secondAlarmEmsUnits].filter(u => u.assign && u.unit).map(u => u.unit).filter((u, i, arr) => arr.indexOf(u) === i);
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    ...
    children: [(0, _jsxRuntime.jsxs)("div", {
      ...
      }), tab !== "lifeflight" ? (0, _jsxRuntime.jsx)("div", {
      ...
      children: [(0, _jsxRuntime.jsx)("div", {
        ...
        children: [tab === "worksheet" && (0, _jsxRuntime.jsxs)("div", {
          ...
          children: [(0, _jsxRuntime.jsx)(GroupHeader, {
            ...
            }), state.commandTransfer.strategyConfirmation != null && (0, _jsxRuntime.jsx)(Section, {
              title: "Strategy Confirmation",
              children: ["Offensive", "Defensive"].map(o => (0, _jsxRuntime.jsx)(Pill, {
            ...
            className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4",
            children: [state.taskSlots.map(slot => (0, _jsxRuntime.jsxs)(Section, {
              title: slot.label,
              children: [(0, _jsxRuntime.jsx)("div", {
                className: "mb-3",
                children: (0, _jsxRuntime.jsx)(TextField, {
            ...
            }, slot.id)), (0, _jsxRuntime.jsxs)(Section, {
              title: "Roof Report",
              children: [(0, _jsxRuntime.jsxs)("div", {
                className: "mb-3",
                children: [(0, _jsxRuntime.jsx)("label", {
            ...
            className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4",
            children: [(0, _jsxRuntime.jsx)(ChecklistSection, {
              title: "Utilities",
              items: UTILITIES_ITEMS,
              data: state.utilities,
              onToggle: (k, l) => toggleSimple("utilities", k, l)
            }), (0, _jsxRuntime.jsxs)(Section, {
              title: "Mutual Aid",
              children: [(0, _jsxRuntime.jsx)(CheckRow, {
                label: "Fire",
              ...
              }), state.medicalRehab.rehab != null && (0, _jsxRuntime.jsx)("div", {
                className: "mb-1.5",
                children: SIDE_OPTS.map(o => (0, _jsxRuntime.jsx)(Pill, {
          ...
          children: [(0, _jsxRuntime.jsxs)("div", {
            ...
            children: [(0, _jsxRuntime.jsxs)("div", {
              ...
              children: [(0, _jsxRuntime.jsxs)("div", {
                ...
                children: [(0, _jsxRuntime.jsx)(TextField, {
                  label: "Age",
                  value: state.lifeFlight.patientAge,
                  onChange: v => setLifeFlightField("patientAge", v),
                  placeholder: "Age"
                }), (0, _jsxRuntime.jsxs)("div", {
                  children: [(0, _jsxRuntime.jsx)("label", {
                    className: "block text-xs uppercase tracking-wide mb-1",
                    ...
                    active: state.lifeFlight.patientSex === o,
                    onClick: () => setLifeFlightField("patientSex", o, `Patient Sex: ${o}`),
                    children: o
                  }, o))]
                })]
              }), (0, _jsxRuntime.jsxs)("div", {
                ...
                children: [(0, _jsxRuntime.jsx)("label", {
                  ...
                  children: [(0, _jsxRuntime.jsx)(TextField, {
                    value: state.lifeFlight.weightKg,
                    onChange: v => handleWeightChange("kg", v),
                    placeholder: "kgs"
                  }), (0, _jsxRuntime.jsx)(TextField, {
                    value: state.lifeFlight.weightLbs,
                    onChange: v => handleWeightChange("lbs", v),
                    placeholder: "lbs"
                  })]
                })]
              }), (0, _jsxRuntime.jsx)(TextField, {
                ...
                }, it.key)), state.lifeFlight.interventions.other != null && (0, _jsxRuntime.jsx)(TextField, {
                  className: "mt-1",

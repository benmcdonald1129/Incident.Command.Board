  ...
  return (0, _jsxRuntime.jsxs)("div", {
    ...
    children: [(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [tab === "mayday" ? (0, _jsxRuntime.jsx)("div", {
          className: "flex flex-wrap items-center gap-2",
          children: maydayManagerLabel && (0, _jsxRuntime.jsxs)("div", {
      ...
      children: [(0, _jsxRuntime.jsx)("div", {
        ...
        children: [tab === "worksheet" && (0, _jsxRuntime.jsxs)("div", {
          ...
          children: [(0, _jsxRuntime.jsxs)(Section, {
            ...
            title: "8. Transmit",
            children: (0, _jsxRuntime.jsx)(CheckRow, {
              label: `"Command to all units, there is a Mayday in progress, (Who, What, Where), maintain radio silence."`,
            ...
            children: [(0, _jsxRuntime.jsx)(CheckRow, {
              ...
              label: "Assign control of the rescue event to a Division Officer",
              value: state.mayday.step9DivisionControl,
              onToggle: () => toggleSimple("mayday", "step9DivisionControl", "Step 9: Assign control of the rescue event to a Division Officer")
            }), (0, _jsxRuntime.jsx)(CheckRow, {
              label: "Assign Level 2 Staging for the next alarm",
              value: state.mayday.step9Level2Staging,
              onToggle: () => toggleSimple("mayday", "step9Level2Staging", "Step 9: Assign Level 2 Staging for the next alarm")
            }), (0, _jsxRuntime.jsxs)("div", {
              className: "mt-2",
              children: [(0, _jsxRuntime.jsx)("label", {
                className: "block text-xs uppercase tracking-wide mb-1",
